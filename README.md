...
git clone https://github.com/your-username/tls-mitm-detection.git
cd tls-mitm-detection

2. Install dependencies
pip install -r requirements.txt

3. Ensure Wireshark and TShark are installed

Wireshark must be installed and added to the system PATH
...
Use Wireshark to capture HTTPS traffic and save it as:
...
This indicates that a small subset of TLS handshakes exhibited abnormal behavior consistent with potential MITM interference.

Limitations

Anomalies indicate suspicion, not definitive confirmation of MITM attacks

Detection accuracy depends on quality and representativeness of baseline traffic

TLS 1.3 limits visibility of certain handshake fields

Environmental factors may cause false positives
...
Support for additional TLS features
